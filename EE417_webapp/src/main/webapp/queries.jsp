...
<div class="header">
  ...
  <ul> <a href="#" style= "color:black"><b>Customer Queries</b></a></ul>
  <h1>BOOKS & POSTERS</h1>
</div>
...
<!--Creation of Dropdown button with drop down elements as links-->
  ...
  <a href="datatable.jsp"><b>Customer Data</b></a>
</div>
...
SELECT fullname, email, querytype, details FROM mydatabase.queries     </sql:query>

<div class="info">
<p><b>Queries from the Customers</b></p>
</div>
<center>
      <table class="tab">
         <tr>
        ...
        <c:forEach var = "row" items = "${result.rows}">
            <tr>
               ...
               <td><c:out value = "${row.querytype}"/></td>
